...
@Database(entities = [com.calmcast.podcast.data.Podcast::class, com.calmcast.podcast.data.Episode::class, com.calmcast.podcast.data.PlaybackPosition::class, Download::class], version = 11)
...
.addMigrations(Migrations.MIGRATION_6_7, Migrations.MIGRATION_7_8, Migrations.MIGRATION_8_9, Migrations.MIGRATION_9_10, Migrations.MIGRATION_10_11)
